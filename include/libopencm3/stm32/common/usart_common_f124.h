...
static inline bool usart_clear_to_send(uint32_t usart)
{
...
static inline bool usart_line_break(uint32_t usart)
{
...
static inline bool usart_tx_empty(uint32_t usart)
{
...
static inline bool usart_rx_not_empty(uint32_t usart)
{
...
static inline bool usart_transmission_complete(uint32_t usart)
{
...
static inline bool usart_idle(uint32_t usart)
{
...
static inline bool usart_overrun_error(uint32_t usart)
{
...
static inline bool usart_noise_error(uint32_t usart)
{
...
static inline bool usart_framing_error(uint32_t usart)
{
...
static inline bool usart_parity_error(uint32_t usart)
{
